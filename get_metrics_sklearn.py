...
def main():
    ...
    p.add_argument("--root", default="dmpnn_tc_cv10", help="Root with replicate_*/model_0/")
    ...
    p.add_argument("--save", default="metrics_summary.csv", help="Where to save the summary CSV")
    args = p.parse_args()
